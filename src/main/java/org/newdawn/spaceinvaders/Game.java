 ...
 * <p/>
 * As a mediator it will be informed when entities within our game detect
 * events (e.g. alien killed, played died) and will take appropriate game
 * actions.
 *
 * @author Kevin Glass
 */
public class Game extends Canvas {
    ...
    private class KeyInputHandler extends KeyAdapter {
        ...
        public void keyTyped(KeyEvent e) {
            // if we're waiting for a "any key" type then check if we've
